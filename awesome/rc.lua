...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "u", function () awful.layout.inc(-1)                end,
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = border_size_lc, -- beautiful.border_width,
...
client.connect_signal("focus", function(c) c.border_color = focus_colour end)
client.connect_signal("unfocus", function(c) c.border_color = normal_colour end)
-- }}}
